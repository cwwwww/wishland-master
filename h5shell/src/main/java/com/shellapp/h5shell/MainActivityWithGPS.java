...
/**
 * Created by MSI on 2018/7/2.
 */

public class MainActivityWithGPS extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setContentView(R.layout.activity_gps);
        ...
        llAdvance = (LinearLayout) findViewById(R.id.ll_advance);
        ...
        setGPSClickListener(llBack);
        setGPSClickListener(llAdvance);
        setGPSClickListener(llHome);
        setGPSClickListener(llRefresh);
        setGPSClickListener(llClear);
    ...
    private void setGPSClickListener(LinearLayout view) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    break;
                    case R.id.ll_clear: {
                        Toast.makeText(MainActivityWithGPS.this, "清除缓存成功！", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
            }
    ...
    private void saveImage(String imgUrl, String destFileDir, String destFileName) {
        OkGo.get(imgUrl).tag(this).execute(new FileCallback(destFileDir, destFileName) {
            ...
            public void onSuccess(File file, Call call, Response response) {
                ...
                intent.setData(uri);
                MainActivityWithGPS.this.sendBroadcast(intent);
                ToastUtil.showShort(MainActivityWithGPS.this, "保存成功");
            }

            @Override
            public void onError(Call call, Response response, Exception e) {
                super.onError(call, response, e);
                ToastUtil.showShort(MainActivityWithGPS.this, "保存失败");
            }
        });
    }
...
//                        Log.e("cww",s+"后台返回的数据！");
                        ...
                        if (isCheckUpdate(appUpdate)) {
                            MaterialDialog.Builder builder = new MaterialDialog.Builder(MainActivityWithGPS.this);
