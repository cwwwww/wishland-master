...
public class MyPickerForDate extends WheelPicker {
    /**
     * 不显示
     */
...
//    private ArrayList<String> minutes = new ArrayList<>();
    ...
    private String yearLabel = "时", monthLabel = "分", dayLabel = "秒";
    ...
    private MyPickerForDate.OnWheelListener onWheelListener;
    private MyPickerForDate.OnDateTimePickListener onDateTimePickListener;
     ...
     * @see #HOUR_12
     */
    public MyPickerForDate(Activity activity, @MyPickerForDate.TimeMode int timeMode, String label1, String label2, String label3) {
        this(activity, YEAR_MONTH_DAY, timeMode, label1, label2, label3);
    }

    public MyPickerForDate(Activity activity, @MyPickerForDate.DateMode int dateMode, @MyPickerForDate.TimeMode int timeMode, String label1, String label2, String label3) {
        super(activity);
        this.yearLabel = label1;
        this.monthLabel = label2;
        this.dayLabel = label3;
...
//        this.minuteLabel = minuteLabel;
    ...
    public void setOnWheelListener(MyPickerForDate.OnWheelListener onWheelListener) {
        this.onWheelListener = onWheelListener;
    }

    public void setOnDateTimePickListener(MyPickerForDate.OnDateTimePickListener listener) {
...
//                }
    ...
    protected void onSubmit() {
        ...
        switch (dateMode) {
            case YEAR_MONTH_DAY:
                ((MyPickerForDate.OnYearMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(year, month, day, hour, minute);
                break;
            case YEAR_MONTH:
                ((MyPickerForDate.OnYearMonthTimePickListener) onDateTimePickListener).onDateTimePicked(year, month, hour, minute);
                break;
            case MONTH_DAY:
                ((MyPickerForDate.OnMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(month, day, hour, minute);
                break;
            case NONE:
                ((MyPickerForDate.OnTimePickListener) onDateTimePickListener).onDateTimePicked(hour, minute);
                break;
        }
    }
...
//        }
    ...
    public interface OnYearMonthDayTimePickListener extends MyPickerForDate.OnDateTimePickListener {

        void onDateTimePicked(String year, String month, String day, String hour, String minute);

    }

    public interface OnYearMonthTimePickListener extends MyPickerForDate.OnDateTimePickListener {
    ...
    public interface OnMonthDayTimePickListener extends MyPickerForDate.OnDateTimePickListener {

        void onDateTimePicked(String month, String day, String hour, String minute);
    }


    public interface OnTimePickListener extends MyPickerForDate.OnDateTimePickListener {
