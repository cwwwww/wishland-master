...
public class MyPickerForTime extends WheelPicker {
    /**
     * 不显示
     */
    ...
    private MyPickerForTime.OnWheelListener onWheelListener;
    private MyPickerForTime.OnDateTimePickListener onDateTimePickListener;
    private int dateMode = YEAR_MONTH_DAY, timeMode = HOUR_24;
    private int startYear = 00, startMonth = 00, startDay = 00;
    private int endYear = 23, endMonth = 59, endDay = 59;
     ...
     * @see #HOUR_12
     */
    public MyPickerForTime(Activity activity) {
        this(activity, YEAR_MONTH_DAY);
    }

    public MyPickerForTime(Activity activity, @MyPickerForTime.DateMode int dateMode) {
        super(activity);
    ...
    public void setOnWheelListener(MyPickerForTime.OnWheelListener onWheelListener) {
        this.onWheelListener = onWheelListener;
    }

    public void setOnDateTimePickListener(MyPickerForTime.OnDateTimePickListener listener) {
...
//                }
    ...
    protected void onSubmit() {
        ...
        switch (dateMode) {
            case YEAR_MONTH_DAY:
                ((MyPickerForTime.OnYearMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(year, month, day);
                break;
            case YEAR_MONTH:
                ((MyPickerForTime.OnYearMonthTimePickListener) onDateTimePickListener).onDateTimePicked(year, month);
                break;
            case MONTH_DAY:
                ((MyPickerForTime.OnMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(month, day);
                break;
            case NONE:
//                ((MyPickerForTime.OnTimePickListener) onDateTimePickListener).onDateTimePicked(hour, minute);
                break;
        }
    }
    ...
    public interface OnYearMonthDayTimePickListener extends MyPickerForTime.OnDateTimePickListener {

        void onDateTimePicked(String year, String month, String day);

    }

    public interface OnYearMonthTimePickListener extends MyPickerForTime.OnDateTimePickListener {
    ...
    public interface OnMonthDayTimePickListener extends MyPickerForTime.OnDateTimePickListener {
