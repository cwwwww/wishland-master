...
public class DrawHistoryAdapter extends SuperAdapter<QuestDealBean.QuestDealData.CommonBean> {

    private OnItemClickListener mOnItemClickListener = null;
    private int type;
    private Activity ctx;

    public DrawHistoryAdapter(Activity ctx, int type) {
        super(ctx);
        this.type = type;
        this.ctx = ctx;
    }
    ...
    protected void onBindItemView(View view, int viewType, final int position) {
        QuestDealBean.QuestDealData.CommonBean queryBean = getItem(position);
