...
import com.wishland.www.wanhaohui2.view.activity.ChangeUserNameActivity;
...
public class MindFragment extends UmengFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @BindView(R.id.lv_update_background)
    RelativeLayout lv_update_background;
    ...
    static {
        ...
        SKIP.put("编辑", ChangeUserNameActivity.class);
        SKIP.put("清除缓存", null);
    }

    @OnClick({R.id.ll_pb, R.id.ll_contact_us, R.id.ll_zhuanhuan_info, R.id.iv_sign_in, R.id.ll_zhudan_info, R.id.tv_user_detail, R.id.ll_deposit, R.id.ll_with_draw, R.id.ll_line_conversion, R.id.ll_discounts, R.id.ll_records_query,
            R.id.ll_personal_info, R.id.ll_mind_message,
            R.id.ll_complain_advice, R.id.ll_login_out, R.id.ll_clean_cache, R.id.tv_bianji
    })
                ...
                try {
                    ...
                    if (status == 200) {
                        try {
                            ...
                            boolean canEdit = instance.getJsonObject(s).optJSONObject("data").optBoolean("editcheck");
                            if (canEdit) {
...
//                            instance.skipLoginActivity(getActivity(), LoginActivity.class);
    ...
    private void setVipView() {
        ...
        String ztzjeNeed;
        if (nextlevel == null) {
//            lv_update_background.setVisibility(View.GONE);
//            ivVip2.setVisibility(View.GONE);
//            mp.setVisibility(View.GONE);
//            mp_two.setVisibility(View.GONE);
            ...
            Glide.with(getContext()).load("").into(ivVip2);
        } else {
//            ivVip2.setVisibility(View.VISIBLE);
//            lv_update_background.setVisibility(View.VISIBLE);
//            mp.setVisibility(View.VISIBLE);
//            mp_two.setVisibility(View.VISIBLE);
            ...
            //vip图片设置
            Glide.with(getContext()).load(levelInfo.getLevelimg()).into(ivVip1);
            Glide.with(getContext()).load(nextlevel.getLevelimg()).into(ivVip2);
            //保存图片地址
