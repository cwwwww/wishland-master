...
import com.wishland.www.wanhaohui2.utils.AndroidBug54971Workaround;
    ...
    private WebViewClient setWebViewClient() {
        WebViewClient webViewClient = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView wv, String url) {
                ...
                //处理http和https开头的url
                Log.e("cww", "url3" + url);
                if (url.contains("index.php/login")) {
                    model.skipLoginActivity(DetailsHtmlPageActivity.this, LoginActivity.class, "DetailsHtmlPageActivity");
                    finish();
                } else {
                    UmengAnalysisGaming();
                }
...
//                    Intent intent = new Intent(DetailsHtmlPageActivity.this, WebViewForDiscountActivity.class);
//                    intent.putExtra(BaseApi.HTML5DATA, BaseApi.CustomHtml5);
//                    startActivity(intent);
//                    finish();
////                    Intent intent = new Intent(DetailsHtmlPageActivity.this, MyDiscountActivity.class);
////                    if (aId != null && !"null".equals(aId) && !"".equals(aId)) {
...
//                }
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                MaterialDialog.Builder builder = new MaterialDialog.Builder(DetailsHtmlPageActivity.this);
