...
public class LottoFirstAdapter2 extends SuperAdapter<CaipiaoBean.ItemsBean.SubcreditBean> {
    ...
    public LottoFirstAdapter2(Activity ctx, Model model, UserSP userSP, Handler handler) {
        super(ctx);
        ...
        llCollect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (userSP.getInt(UserSP.LOGIN_SUCCESS) == 1) {
                    ...
                    model.skipLoginActivity(activity, LoginActivity.class, "LottoFirstAdapter2");
                }
            }
        });
    }
