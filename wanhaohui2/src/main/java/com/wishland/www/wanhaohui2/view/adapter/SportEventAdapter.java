...
public class SportEventAdapter extends SuperAdapter<HomeGameBean.DataBean.GameBean.ItemsBean> {
    ...
    public SportEventAdapter(Activity ctx, Model instance, UserSP userSP, Handler mHandler, String gameImage) {
        super(ctx);
        this.activity = ctx;
    ...
    protected View onCreateItemView(ViewGroup parent, int viewType) {
        return mInflater.inflate(R.layout.item_sport_event, parent, false);
    }
    ...
    protected void onBindItemView(View view, int viewType, int position) {
        ...
        HomeGameBean.DataBean.GameBean.ItemsBean itemBean = getItem(position);
        FrescoUtil.loadGifPicOnNet(simpleDraweeView, itemBean.getImg());
        tvName.setText(itemBean.getName());
        if (itemBean.getFavorite() || cbList.contains(position)) {
        ...
        setCBClickListener(llCollect, cbCollect, itemBean, position);
        ...
        llCollect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (userSP.getInt(UserSP.LOGIN_SUCCESS) == 1) {
                    ...
                    instance.skipLoginActivity(activity, LoginActivity.class, "SportEventAdapter");
                }
            }
        });
    }
            ...
            public void onNext(ResponseBody responseBody) {
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        String errorMsg = jsonObject.optString("errorMsg");
                        if (errorMsg.equals("用户未登录")) {
                            instance.skipLoginActivity(activity, LoginActivity.class, "SportAdapter2");
                        } else {
                            ToastUtil.showShort(mContext, errorMsg);
                        }
                    }
