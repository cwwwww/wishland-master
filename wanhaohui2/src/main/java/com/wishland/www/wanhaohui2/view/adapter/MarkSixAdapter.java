...
public class MarkSixAdapter extends SuperAdapter<HomeGameBean.DataBean.GameBean.ItemsBean> {
    ...
    public MarkSixAdapter(Activity ctx, Model model, UserSP userSP, Handler handler, String gameImage) {
        super(ctx);
        this.mContext = ctx;
        activity = ctx;
        this.model = model;
    ...
    protected View onCreateItemView(ViewGroup parent, int viewType) {
        return mInflater.inflate(R.layout.item_mark_six, parent, false);
    }
        ...
        llCollect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (userSP.getInt(UserSP.LOGIN_SUCCESS) == 1) {
                    ...
                    model.skipLoginActivity(activity, LoginActivity.class, "MarkSixAdapter");
                }
            }
        });
    }
