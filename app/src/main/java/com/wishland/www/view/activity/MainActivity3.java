...
//        mainMessagepageButton.setBackgroundColor(getResources().getColor(R.color.transparent));
    ...
    @OnClick({R.id.signout, R.id.setting_button, R.id.login_username, R.id.ll_main, R.id.ll_fund, R.id.ll_line, R.id.fl_message, R.id.ll_customer, R.id.signin, R.id.loginin})
...
//                        mainMessagepageButton.setBackgroundResource(R.drawable.radiogroup_selector_readiobutton_pressed);
    ...
    private void loginOutRequest() {
        ...
        instance.apiLoginOut(token, NetUtils.getParamsPro().get("signature"), new Subscriber<ResponseBody>() {
            ...
            public void onError(Throwable e) {
                ...
                ToastUtil.showShort(MainActivity3.this, "网络异常...");
            }
            ...
            public void onNext(ResponseBody out) {
                ...
                try {
                    ...
                    signin.setVisibility(View.VISIBLE);
                    loginin.setVisibility(View.VISIBLE);
                    ToastUtil.showShort(MainActivity3.this, "已登出");
                    removeFragment();
                } catch (IOException e) {
                    AppUtils.getInstance().onRespons("注销失败" + e.getMessage());
                    e.printStackTrace();
    ...
    public void requestGlobal() {
        ...
        instance.apiGlobal(token, NetUtils.getParamsPro().get("signature"), new Subscriber<ResponseBody>() {
            ...
            public void onError(Throwable e) {
                ...
                LogUtil.e("全局信息获取异常");
                ToastUtil.showShort(MainActivity3.this, "全局信息请求异常");
            }
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        if (errorMsg.equals("用户未登录")) {
                            instance.skipLoginActivity(MainActivity3.this, LoginInActivity.class);
                        } else {
                            ToastUtil.showShort(MainActivity3.this, errorMsg);
                        }
                    }
    ...
    public void updataVersions() {
        ...
        Model.getInstance().updata(token, NetUtils.getParamsPro().get("signature"), new Subscriber<ResponseBody>() {
            ...
            @Override
            public void onError(Throwable e) {
                ToastUtil.showShort(MainActivity3.this, "服务器异常");
            }
            ...
            public void onNext(ResponseBody responseBody) {
                try {
                    ...
                    if (status == 200) {
                        ...
                        if (!UtilTools.getVersion(MainActivity3.this).equals(Updataversion)) {
        ...
        if (force) {
            ...
            new AlertDialog.Builder(this)
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    ToastUtil.showShort(MainActivity3.this, "取消更新");
                    dialog.dismiss();
                }
            }).setCancelable(false).show();
        }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (coon.getResponseCode() == 200) {
                        ...
                        ToastUtil.showUI(MainActivity3.this, "网络异常...");
...
//        90d4dc60283f79f75d29777fbbcc4528
        ...
        if (TextUtils.isEmpty(versionCode) || TextUtils.isEmpty(url)) {
            return;
        }
        OkGo.post(url)
                ...
                .execute(new AbsCallback<String>() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (appVersion < appUpdate.getEntity().getVersion()) {
                            MaterialDialog.Builder builder = new MaterialDialog.Builder(MainActivity3.this);
                            builder.title("发现新版本");
